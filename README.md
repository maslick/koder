<kbd style="background-color:#f03c15; color: white; padding: 10px; text-align: right">🚀 Check Out [Kameroon](https://github.com/maslick/kameroon) - QR/Bar Code Scanner as a Service 🚀 </kbd> 
